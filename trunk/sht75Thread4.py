...
class Sht75Thread4(QThread):
    ...
    def __init__(self,sht75_server):
        ...
        self.humidity = 0.00
        self.sht75_server4 = DeviceProxy(sht75_server)
    ...
    def readAttributes(self):
        self.temperature = self.sht75_server4.Temperature
        self.humidity = self.sht75_server4.Humidity
