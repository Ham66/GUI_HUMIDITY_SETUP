...
class Sht75Thread3(QThread):
    ...
    def __init__(self,sht75_server):
        ...
        self.humidity = 0.00
        self.sht75_server3 = DeviceProxy(sht75_server)
    ...
    def readAttributes(self):
        self.temperature = self.sht75_server3.Temperature
        self.humidity = self.sht75_server3.Humidity
